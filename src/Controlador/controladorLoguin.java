...
import Servicios.ConeccionUsuario;
...
public class controladorLoguin implements ActionListener{
    ...
    private final ConeccionUsuario model=new ConeccionUsuario();
    ...
    public controladorLoguin(login vista){
        this.view=vista;
        events();
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(evt.equals(view.btn_enter)){
            ...
            if(clavedef.isEmpty() || view.txt_user.getText().isEmpty()){
                ...
                ArrayList<UsuarioLoguin> list;
                list = model.login(view.txt_user.getText(), clavedef);
                
                if(list.size()>0){
                    
                    JOptionPane.showMessageDialog(null, "Bienvenido al sistema", "Agraf Industrial S.A.S", JOptionPane.INFORMATION_MESSAGE);
                    view.dispose();
